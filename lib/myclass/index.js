...
class MyClass {
  ...
  /**
   * Import extracted methods and bind their 'this' reference to the current instance of MyClass
   * @method
   * @private
   */
  importMethods() {
    this.cachedMethods = new Map();
    this.cachedMethods.set('myMethodTwo', myMethodTwo.bind(this));
  }
   ...
   */
  myMethodTwo() {
    return this.cachedMethods.get('myMethodTwo')(arguments);
  }
}
