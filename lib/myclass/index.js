...
const MyClassHelperOne = require('./myclasshelperone');
const MyClassHelperTwo = require('./myclasshelpertwo');
 ...
 * @property {MyClassHelperOne} myClassHelperOne - an instance of MyClassHelperOne
 * @property {MyClassHelperTwo} myClassHelperTwo - an instance of MyClassHelperTwo
 */
class MyClass {
  /**
  ...
  constructor(one, two) {
    ...
    this.myClassHelperOne = new MyClassHelperOne(this);
    this.myClassHelperTwo = new MyClassHelperTwo(this);
  }
   ...
   */
  get myMethodOne() {
    return this.myClassHelperOne.myMethod;
  }
   ...
   */
  get myMethodTwo() {
    return this.myClassHelperTwo.myMethod;
  }
}
